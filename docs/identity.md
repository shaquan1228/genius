...
- [Iterate only when it loads a fork's spring][qbt-004]
...
- [Tinkering test](dreams/STOP-TINKERING.md) — operational discriminator for [qbt-004]
...
[qbt-004]: proofs/004-FORK-LOADED-ITERATION.md
